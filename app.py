...
# ---- LOAD ASSETS ----
lottie_coding = load_lottieurl("https://lottie.host/4577b2cc-4dff-406f-9d92-3a4ff08b7847/7Em5OZkQ2p.json")
img_huawei_History = Image.open("images/huawei_History.png")
img_huawei_web = Image.open("images/huawei_web.png")
